...
public class PrecedingCommits {
    ...
    protected List<PrecedingCommit> precedingCommit;
     ...
     * {@link PrecedingCommit }
     */
    public List<PrecedingCommit> getPrecedingCommit() {
        if (precedingCommit == null) {
            precedingCommit = new ArrayList<PrecedingCommit>();
        }
